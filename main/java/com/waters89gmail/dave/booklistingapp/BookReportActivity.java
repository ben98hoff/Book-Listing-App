...
public class BookReportActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    */
    ...
    public void onClick(View v) {
        ...
        /*
        Starting a new AsyncTask to load new page of books.  If prev arrow or text is pressed will index backwards to view previous pages
        * If next arrow or text is pressed will index forward to display new page of books.
        * Updating gdRequestURL with new index value before starting new AsyncTask so next or previous set of data will be sent.
         */
    ...
    private class BookSearchAsyncTask extends AsyncTask<URL, Void, ArrayList> {
        ...
        protected ArrayList<BookObject> doInBackground(URL... urls) {
            ...
            // Return the {@link Event} object as the result fo the {@link BookSearchAsyncTask}
            return extractFeatureFromJson(jsonResponse);
        }

        /**
         * Update the screen with the books list (which was the result of the
         * {@link BookSearchAsyncTask}).  Also dismiss Progress asyncDialog.
         */
        @Override
        ...
        /**
         * Return an {@link BookObject} object by parsing out information
    ...
    /**
     * Show a custom alert dialog.  Dialog can be used in multiple cases as message is passed as param @param alertMessage
     */
